...
import datavisualizerwithobserver.view.textpresentation.TextController;
...
public class ViewHandler {
    ...
    public void openView(String viewToOpen) throws IOException {
        ...
        if("PieChart".equals(viewToOpen)) {
            ...
            loader.setLocation(getClass().getResource("../view/textpresentation/Text.fxml"));
            root = loader.load();
            TextController view = loader.getController();
            view.init(mvViewModel.getTextViewModel());
            tmpStage.setTitle("TEXT");
        }
