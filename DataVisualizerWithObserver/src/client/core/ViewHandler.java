...
import client.view.barchart.BarChartController;
import client.view.piechart.PieChartController;
import client.view.textpresentation.TextController;
...
public class ViewHandler {
    ...
    public void openView(String viewToOpen) throws IOException {
        ...
        if("PieChart".equals(viewToOpen)) {
            loader.setLocation(getClass().getResource("../client.core.view/piechart/PieChart.fxml"));
            root = loader.load();
            ...
            loader.setLocation(getClass().getResource("../client.core.view/barchart/BarChart.fxml"));
            root = loader.load();
            ...
            loader.setLocation(getClass().getResource("../client.core.view/textpresentation/Text.fxml"));
            root = loader.load();
