...
import client.view.uppercase.LogViewController;
...
public class ViewHandler {
    ...
    public void openView(String viewToOpen) throws IOException {
        ...
        if ("convert".equals(viewToOpen)) {
            loader.setLocation(getClass().getResource("../client.core.view/uppercase/UppercaseView.fxml"));
            root = loader.load();
            ...
            loader.setLocation(getClass().getResource("../client.core.view/uppercase/LogView.fxml"));
            root = loader.load();
